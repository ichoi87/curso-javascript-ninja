(function() {
  ...
  */
  console.log( '\nJust Numbers:' );
  var justNumbers = numberObjects.map((i) => {
    return i.number;
  });
  ...
  */
  ...
  var justMod2Or3 = justNumbers.filter((i) => {
    return i % 2 === 0 && i % 3 === 0;
  });
  ...
  */
  console.log( '\nOperation:' );
  var operation = justMod2Or3.reduce((acc, cur, ind) => {
    return (acc + 1) * cur;
  }, 0);
  ...
  */
  ...
  var name = ['f', 'e', 'l', 'i', 'p', 'e'];
  var reduce = name.reduce((acc, cur) => {
    return acc + 'P' + cur;
  });
  console.log(reduce);
  ...
  */
  ...
  if(Array.isArrayjustMod2Or3()) { console.log(justMod2Or3.toString()) };
})();
