...
cleanCPF('049-214 3421-1').replace(/(\d{3})(\d{3})(\d{3})(\d{2})/g, (regex, arg1, arg2, arg3, arg4) => {
...
console.log(text.match(/ju\w{3,4}/g));
...
var newTags = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";
console.log(newTags.match(/(\<\w+\>\<\/\w+\>)/g));
...
var h1 = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";
var regexDate = /(\<\w+\>)([^>]+)+<\/\w+>/g;
console.log(h1.replace(regexDate, (regex, arg1, arg2) => {
