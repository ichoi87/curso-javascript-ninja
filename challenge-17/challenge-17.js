...
console.log(text.replace('Manuel Marques de Sousa', 'Felipe Choi'));
...
console.log(text.replace('brasileiro', 'coreano'));
...
console.log(text.replace(/O Centauro de Luvas/g, (p) => p.toUpperCase()));
...
var set = 'setembro';
var dez = 'dezembro';
console.log(`O mês de ${mar} é representado pelo número ${getMonthNumber(mar)}.`);
console.log(`O mês de ${set} é representado pelo número ${getMonthNumber(set)}.`);
console.log(`O mês de ${dez} é representado pelo número ${getMonthNumber(dez)}.`);
